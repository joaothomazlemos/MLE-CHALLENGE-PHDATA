...
class Config(BaseSettings):
    ...
    model_features_path: str = Field(default="model/model_features.json", env="MODEL_FEATURES_PATH")
    demographics_path: str = Field(default="data/zipcode_demographics.csv", env="DEMOGRAPHICS_PATH")
    
    title: str = "Sound Realty House Price Prediction API"
    description: str = "REST API for predicting house prices in the Seattle area using machine learning"
    version: str = "1.0.0"
